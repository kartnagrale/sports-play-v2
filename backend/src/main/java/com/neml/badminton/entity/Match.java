...
@Entity
@Table(name = "matches", uniqueConstraints = @UniqueConstraint(columnNames = {"championship_id", "match_number"}),
        indexes = @Index(name = "idx_match_championship", columnList = "championship_id"))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
