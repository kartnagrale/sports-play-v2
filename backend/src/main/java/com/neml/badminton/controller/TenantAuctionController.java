...
public class TenantAuctionController {
    ...
    public AuctionStateDto bid(@PathVariable UUID championshipId,@PathVariable UUID auctionId,@RequestBody PlaceBidRequest req){return service.bid(championshipId,auctionId,req);}
    ...
    public AuctionStateDto setCurrent(@PathVariable UUID championshipId,@PathVariable UUID auctionId,@RequestBody NextPlayerRequest req){return service.setCurrent(championshipId,auctionId,req.playerId());}
    ...
    public AuctionStateDto setStatus(@PathVariable UUID championshipId,@PathVariable UUID auctionId,@RequestBody SetStatusRequest req){return service.status(championshipId,auctionId,req.status());}
    ...
    public PlayerDto price(@PathVariable UUID championshipId,@PathVariable UUID auctionId,@PathVariable UUID playerId,@RequestBody UpdateBasePriceRequest req){return service.basePrice(championshipId,auctionId,playerId,req.basePrice());}
}
